...
@Getter
@Setter
open class SimpleRecyclerAdapter<A>(private var mainData: List<A>, @field:LayoutRes private val layoutRes: Int, private val listener: OnViewHolder<A>) :
    ...
    fun setMainData(mainData: List<A>) {
